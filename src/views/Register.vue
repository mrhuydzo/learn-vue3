          ...
          <form class="space-y-4 md:space-y-6" @submit.prevent="onSubmit">
            <div>
              <label for="fullname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Full
                name</label>
              <input type="text" v-model="fullName" name="email" id="fullname"
            ...
            <!--&lt;!&ndash;                <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept the <a class="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">Terms and Conditions</a></label>&ndash;&gt;-->
            <!--&lt;!&ndash;              </div>&ndash;&gt;-->
            <!--            </div>-->
            ...
            <button v-else disabled type="submit"
                    class="w-full text-white bg-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Loading...
            </button>
...
export default {
  ...
  setup() {
    ...
    async function onSubmit() {
      ...
      if (!error.value) await router.push('/profile')
    }
